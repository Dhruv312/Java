...
class Cart {
    ...
    public void addItem(Item item1) {
        if (counter < item.length) {
            ...
            System.out.println("can not add more item");
        }
    }
    ...
    public Item findItem(String name) {
        for (int i = 0; i < counter; i++) {
            if (item[i].getName().equals(name)) {
                System.out.println("Find Item succesfully");
                // System.out.println("Name: " + item[i].getName() + ", Salary: "
                // + item[i].getPrice() + ", Quantity: " + item[i].getQuantity());
                return item[i];
            }
        }
    ...
    public void updatePrice(String name, double price) {
        Item itemUpdate = findItem(name);
        if (itemUpdate != null) {
            System.out.println("Update Item succesfully");
    ...
    public void displayInfo() {
        for (int i = 0; i < counter; i++) {
            System.out.println("Name: " + item[i].getName() + ", Price: "
                    + item[i].getPrice() + ", Quntity: " + item[i].getQuantity());
        }
    }
}
...
public class Task4 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    System.out.print("Eneter Item Name: ");
                    String name = sc.next();
                    System.out.print("Eneter Item Price: ");
                    double price = sc.nextDouble();
                    System.out.print("Eneter Item Quantity: ");
